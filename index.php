...
getHeader("Accueil", "aztrek site de voyage ....", [], 'home');
?>
            ...
            <article class="article-cdc">
                ...
                <div class="infos">
                    ...
                    <ul>
                        ...
                        <li class="blog"><a href="#">SUIVEZ MARIE<img
                                        src="images/2_coups_de_coeur/blogger-letter-logotype_bleu.png"
            ...
            <article class="article-cdc">
                ...
                <div class="infos">
                    ...
                    <ul>
                        ...
                        <li class="blog"><a href="#">SUIVEZ STEN<img
                                        src="images/2_coups_de_coeur/blogger-letter-logotype_bleu.png"
                                        alt="blog" class="picto-blog"/></a></li>
            ...
            <article class="article-cdc">
                ...
                <div class="infos">
                    ...
                    <ul>
                        ...
                        <li class="prix"><a href="#">8 jours à partir de 2100€</a></li>
                        <li class="blog"><a href="#">SUIVEZ LORIE<img
                                        src="images/2_coups_de_coeur/blogger-letter-logotype_bleu.png"
                                        alt="blog" class="picto-blog"/></a></li>
            ...
            <article class="article-cdc">
                ...
                <div class="infos">
                    ...
                    <ul>
                        <li class="pays"><a href="#">SALVADOR</a></li>
                        <li class="prix"><a href="#">8 jours à partir de 2100€</a></li>
                        <li class="blog"><a href="#">SUIVEZ FLO<img
                                        src="images/2_coups_de_coeur/blogger-letter-logotype_bleu.png"
                                        alt="blog" class="picto-blog"/></a></li>
            ...
            <article class="article-cdc">
                ...
                <div class="infos">
                    ...
                    <ul>
                        ...
                        <li class="prix"><a href="#">8 jours à partir de 2100€</a></li>
                        <li class="blog"><a href="#">SUIVEZ CAMILLE<img
                                        src="images/2_coups_de_coeur/blogger-letter-logotype_bleu.png"
                                        alt="blog" class="picto-blog"/></a></li>
...
<section class="tout-le-monde-container">
    ...
    <div class="container">
        ...
        <div class="interview">
            ...
            <article class="item">
                <div class="item-img"><a href=""><img src="images/4_temoignages/market-960361_1920.jpg" alt=""></a>
                </div>
                <div class="item-infos">
                    <h3>Juanita - habitante Salvador</h3>

                    <p> « Je suis ravie à chaque visite, je fais de belles rencontres . Les voyageurs nous aident bien
                        dans
                        notre
            ...
            <article class="item">
                <div class="item-img"><a href=""><img src="images/4_temoignages/Melinda_Garcia_Conseillere_voyage.jpg"
                                                      alt=""></a></div>
                <div class="item-infos">
                    <h3>Sophie - spécialiste voyage Amérique centrale</h3>

                    <p> « Je suis ravie d'avoir rejoint l'agence de voyage Aztrek; une agence dynamique avec de vrais
                        valeures
                        éco responsables .Je peux vraiment proposer des voyages plutôt découverte et aventure,I ls m'ont
                        fait
